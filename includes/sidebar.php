        <ul class="nav navbar-nav side-nav">
                    ...
                    <li class=''>
                        <a href="index.php?page=employee&io=1"><i class="fa fa-fw fa-users"></i>Engineers List</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a id="dem3" href="javascript:;" data-toggle="collapse" data-target="#demo3"><i class="fa fa-fw fa-gears"></i>Manage Reports<i class="fa fa-fw fa-caret-down"></i></a>
                        <ul id="demo3" class="collapse">

                             <li>
                             <a href="index.php?page=project_list&io=1"><i class="fa fa-fw fa-files-o"></i> Report</a>
                            </li>
                        </ul>
                    </li>
