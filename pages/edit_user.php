    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <select type="text" class="form-control input-sm" id="u_type" name="u_type">
                ...
                <option value="1" <?php if ($row2['user_type'] == '2') echo 'selected'; ?>>Administrator</option>
                <option value="3" <?php if ($row2['user_type'] == '3') echo 'selected'; ?>>Chief Officer, Infrastructure</option>
                <option value="4" <?php if ($row2['user_type'] == '4') echo 'selected'; ?>>CECM, Infrastructure</option>
                <option value="5" <?php if ($row2['user_type'] == '5') echo 'selected'; ?>>Sub-County Engineer</option>
                <option value="6" <?php if ($row2['user_type'] == '6') echo 'selected'; ?>>Assistant Sub-County Engineer</option>
                <option value="7" <?php if ($row2['user_type'] == '7') echo 'selected'; ?>>Contractor</option>
            </select>
        </div>
    </div>
    <br>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <select type="text" class="form-control input-sm" id="status" name="status">
                ...
                <option value="1" <?php if ($row2['status'] == '2') echo 'selected'; ?>>Active</option>
                <option value="2" <?php if ($row2['status'] == '1') echo 'selected'; ?>>Inactive</option>
            </select>
        </div>
    </div>
    <br>
