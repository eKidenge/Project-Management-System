...
<div class="panel-body">
	...
	<div class="row">
		<div class="col-sm-4 text-right"><label class="control-label">End Date:</label></div>
		<div class="col-sm-8 text-left"><label class="control-label"><?php echo date("F d, Y",strtotime($row['deadline'])) ?></label></div>
	</div>
	<div class="row">
		<div class="col-sm-4 text-right"><label class="control-label">Sub-County:</label></div>
	...
	<div class="row">
		...
		<div class="col-sm-8 text-left"><label class="control-label"><?php echo  $row['overall_cost'] . ' Kshs.' ?></label></div>
	</div>
	
	<div class="row">
		<div class="col-sm-4 text-right"><label class="control-label">Engineer:</label></div>
